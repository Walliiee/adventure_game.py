...
def train_companion(state: dict) -> None:
    """Train selected companion: +level, +bond, mood motivated; Ari bond +1."""
...
def play_with_companion(state: dict) -> None:
    """Play with selected companion: +bond, mood happy, +health; Sol bond +1."""
...
def run_exhibition(state: dict) -> bool:
    """Run the exhibition match. Returns True if the player wins."""
